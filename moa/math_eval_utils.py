"""
Uses the codebase from the paper: 'Step-DPO: Step-wise Preference Optimization for Long-chain Reasoning of LLMs'
Github: https://github.com/dvlab-research/Step-DPO/tree/d46caf6d4f3b88e18b10a5e62e6d864d967e061a 
"""
import re
import regex
...
def parse_interval(interval_str):
    ...
    return [float(p) if p not in ["-inf", "inf"] else p for p in parts]

def compare_intervals(pred, ref):
    try:
