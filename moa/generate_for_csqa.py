...
from csqa_dataset import download_csqa, return_wang_cot_str, add_formated_choice_column, generate_user_query
from utils import (
    generate_together,
    generate_openai,
...
def process_fn(
    ...
    cot_prompt = return_wang_cot_str()

    user_query = generate_user_query(item, cot_prompt)
        ...
        for i_round in range(rounds):
            ...
            for reference_model in reference_models:
                ...
                reference = generate_with_references(
                    ...
                    save_model_usage_path='outputs/csqa'
                )
...
def main(
    ...
    csqs_dataset = download_csqa()
    eval_set = csqs_dataset['validation']   
    # eval_set = eval_set.select(range(11)) 
    eval_set = eval_set.map(add_formated_choice_column)
